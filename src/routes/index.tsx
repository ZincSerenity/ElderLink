  ...
  return (
    <AppShell>
      <section className="px-5 pt-6 pb-4">
        <p className="text-muted-foreground">{greet}, {t("home.user")}</p>
      ...
      <section className="px-5">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-[oklch(0.58_0.2_30)] to-[oklch(0.65_0.18_45)] text-primary-foreground p-6 shadow-lg">
          ...
          <div className="relative">
            ...
            <p className="text-5xl font-display mt-1">1,280 {t("home.pointsUnit")}</p>
            <p className="opacity-90 mt-2">{t("home.needMore")}</p>
            <div className="mt-4 h-2 bg-white/20 rounded-full overflow-hidden">
              <div className="h-full bg-[var(--gold)] rounded-full" style={{ width: "85%" }} />
            </div>
      ...
      <section className="px-5 mt-6">
        <div className="flex items-center gap-2 bg-card border border-border rounded-2xl p-4">
          ...
          <p>{t("home.nextCheckin")}<span className="font-semibold">{t("home.evening6")}</span></p>
        </div>
      </section>
      ...
      <section className="px-5 mt-4 grid grid-cols-2 gap-3">
        <Link
          to="/nearby"
          className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[oklch(0.55_0.16_145)] via-primary to-[var(--gold)] text-primary-foreground p-4 shadow-lg active:scale-[0.98] transition"
        >
        ...
        <Link
          to="/family"
          className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[oklch(0.55_0.18_295)] via-primary to-accent text-primary-foreground p-4 shadow-lg active:scale-[0.98] transition"
        >
          <div className="w-12 h-12 rounded-2xl bg-white/20 flex items-center justify-center mb-2">
        ...
        <div className="grid grid-cols-2 gap-3">
          {featureDefs.map((f) => (
            <Link key={f.to} to={f.to} className="group relative overflow-hidden rounded-2xl bg-card border border-border p-5 transition-all active:scale-95">
              <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${f.tint} flex items-center justify-center text-white mb-3 shadow-sm`}>
      ...
      <section className="px-5 mt-6">
        <div className="rounded-2xl bg-gradient-to-br from-cream to-secondary p-5 border border-border">
          <div className="flex items-center gap-2 text-primary">
            ...
            <p className="font-semibold text-lg">{t("home.family")}</p>
          </div>
          ...
          <div className="flex items-center gap-2 mt-4">
            ...
            <button className="ml-auto text-sm font-semibold text-primary flex items-center gap-1">
              <Users className="w-4 h-4" /> {t("home.share")}
            </button>
          </div>
        </div>
      </section>
