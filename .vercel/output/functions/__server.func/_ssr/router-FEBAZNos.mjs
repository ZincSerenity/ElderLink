import { c as createRouter, a as createRootRouteWithContext, H as HeadContent, S as Scripts, O as Outlet, b as createFileRoute, l as lazyRouteComponent, u as useRouter, L as Link, d as useLocation, e as useNavigate } from "../_libs/tanstack__react-router.mjs";
...
function LanguageProvider({ children }) {
  const [lang, setLangState] = reactExports.useState("zh");
  ...
  const setLang = (l) => {
    setLangState(l);
    try {
      localStorage.setItem("elderlink.lang", l);
    } catch {
    }
  };
  const t = (k) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(LangContext.Provider, { value: { lang, setLang, t }, children });
}
function useLang() {
  const ctx = reactExports.useContext(LangContext);
...
const PUBLIC_PATHS = /* @__PURE__ */ new Set(["/", "/auth"]);
function AuthGate({ children }) {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground", children: "Loading…" }) });
  }
  if (!user && !isPublic) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground", children: "Redirecting…" }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children });
}
const appCss = "/assets/styles-BbMNlUom.css";
...
const Route$c = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "ElderLink connects seniors for easy online chats and photo sharing, simplifying communication." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "ElderLink connects seniors for easy online chats and photo sharing, simplifying communication." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "ElderLink connects seniors for easy online chats and photo sharing, simplifying communication." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/dcec8165-1a1f-4d51-8657-21259da8098b/id-preview-4470011e--fcd2c87b-dc7a-4d68-a53e-bc3c61d3414e.lovable.app-1781959099246.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/dcec8165-1a1f-4d51-8657-21259da8098b/id-preview-4470011e--fcd2c87b-dc7a-4d68-a53e-bc3c61d3414e.lovable.app-1781959099246.png" }
    ],
    links: [
      {
        rel: "stylesheet",
...
function RootComponent() {
  const { queryClient: queryClient2 } = Route$c.useRouteContext();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient2, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LanguageProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AuthGate, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }) }) });
}
const $$splitComponentImporter$b = () => import("./rewards-BOg8mfnk.mjs");
const Route$b = createFileRoute("/rewards")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./nearby-OrgoP_hI.mjs");
const Route$a = createFileRoute("/nearby")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Find ElderLink seniors near you and start chatting in one tap."
    }]
  })
});
const $$splitComponentImporter$9 = () => import("./link-D2Gyr_-M.mjs");
const Route$9 = createFileRoute("/link")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./game-WW11VAWo.mjs");
const Route$8 = createFileRoute("/game")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./family-2W721iVC.mjs");
const Route$7 = createFileRoute("/family")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./checkin-C_TE5Fed.mjs");
const Route$6 = createFileRoute("/checkin")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./chat-Bzr5x303.mjs");
const Route$5 = createFileRoute("/chat")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./auth-Bbx1bVod.mjs");
const Route$4 = createFileRoute("/auth")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Sign in or sign up to ElderLink"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./ai-LmVd1nPR.mjs");
const Route$3 = createFileRoute("/ai")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./account-BeG2-Mda.mjs");
const Route$2 = createFileRoute("/account")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./index-BiObVJ6z.mjs");
const Route$1 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "為長者而設的陪伴應用，遊戲、聊天、AI 建議與每日打卡，賺積分換日用品。"
    }]
  })
});
const $$splitComponentImporter = () => import("./family._userId-B0I2nDhs.mjs");
const Route = createFileRoute("/family/$userId")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const RewardsRoute = Route$b.update({
  id: "/rewards",
  path: "/rewards",
  getParentRoute: () => Route$c
});
const NearbyRoute = Route$a.update({
  id: "/nearby",
  path: "/nearby",
  getParentRoute: () => Route$c
});
const LinkRoute = Route$9.update({
  id: "/link",
  path: "/link",
  getParentRoute: () => Route$c
});
...
const FamilyRoute = Route$7.update({
  id: "/family",
  path: "/family",
  getParentRoute: () => Route$c
});
const CheckinRoute = Route$6.update({
  id: "/checkin",
  path: "/checkin",
  getParentRoute: () => Route$c
});
...
const FamilyUserIdRoute = Route.update({
  id: "/$userId",
  path: "/$userId",
  getParentRoute: () => FamilyRoute
});
const FamilyRouteChildren = {
  FamilyUserIdRoute
};
const FamilyRouteWithChildren = FamilyRoute._addFileChildren(FamilyRouteChildren);
